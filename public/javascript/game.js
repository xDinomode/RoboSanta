...
var Play = {
  preload: function(){
    //load tilemap
    game.load.tilemap("map", "./public/images/game/bluecrosstile4.json", null, Phaser.Tilemap.TILED_JSON);
    game.load.image("tiles", "./public/images/game/tileset.png");

    //load robosanta head
    game.load.image("santaHead", "./public/images/game/headS.png");

    //load robosanta body
    game.load.image("santaBody", "./public/images/game/bodyS.png");

    //load robosanta wheels
    game.load.image("santaLegs", "./public/images/game/wheelS.png");

    game.load.image("block", "./public/images/testitle.jpg");
